	...
	$(function(){
		$('#tt').tree({
			onClick: function(node){
				if(node.url){
					//此处查询的是success中的content，因为在当前页面在框架中，所以实际上是在success中查找id为content的元素，node表示当前节点
...
<body>
	...
	<br>
	<ul id="tt" class="easyui-tree" data-options="url:'tree_data2.json?a=1',method:'get',animate:true"></ul>
